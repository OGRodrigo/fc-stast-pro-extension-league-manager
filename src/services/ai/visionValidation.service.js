...
- No inventes clubes si no aparecen claros.
- No asumas local/visita si no hay evidencia.
...
2. Detectar nombres de clubes solo si están claramente visibles.
...
async function interpretMatchImageOcr({ text = "", lines = [], words = [], imageType = "unknown", meta = {} } = {}) {
